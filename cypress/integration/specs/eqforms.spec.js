...
context('Verify Eloqua forms', () => {
  ...
  it('Verify Contact Sales form', function() {
    ...
    it('Verify Hub page 2010_PA_PP_InfoGatedAsset-Contact_MKTG', function(){
        ...
        cy.get('[name="Organization"]').type(this.testdata.company).should('have.value',this.testdata.company)
        cy.get('[name="Title"]').type(this.testdata.JobFunct).should('have.value',this.testdata.JobFunct)
        cy.get('[name="Phone"]').type(this.testdata.phone).should('have.value',this.testdata.phone)
        cy.get("[name='EmailAddress']").first().type(this.testdata.email).should('have.value',this.testdata.email)
        
        cy.get("[name='companyType1']").select(this.testdata.orgtype).should('have.value', this.testdata.orgtype)
        cy.get("[name='State']").select(this.testdata.state).should('have.value',this.testdata.state)

        cy.get("[name='jobFunction1']").select(this.testdata.JobFunct).should('have.value',this.testdata.JobFunct)
        cy.get("[name='jobLevelFunction1']").select(this.testdata.JobFunct).should('have.value',this.testdata.JobFunct)
